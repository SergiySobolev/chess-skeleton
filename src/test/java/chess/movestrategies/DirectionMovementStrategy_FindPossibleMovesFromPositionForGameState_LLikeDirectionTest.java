...
public class DirectionMovementStrategy_FindPossibleMovesFromPositionForGameState_LLikeDirectionTest {
    @Test
    public void startE5_emptyBoard_distance1() {
    ...
    @Test
    public void startA1_emptyBoard_distance1() {
        MovementStrategy movementStrategy = new DirectionMovementStrategy((byte) 1, Collections.singletonList(Direction.L_LIKE));
    ...
    @Test
    public void startE1_emptyBoard_distance1() {
        MovementStrategy movementStrategy = new DirectionMovementStrategy((byte) 1, Collections.singletonList(Direction.L_LIKE));
    ...
    @Test
    public void startG8_obstaclesH6E7_distance1() {
        MovementStrategy movementStrategy = new DirectionMovementStrategy((byte) 1, Collections.singletonList(Direction.L_LIKE));
        ...
        assertThat(possibleMoves, samePositions(Collections.singletonList("f6")));
    }
